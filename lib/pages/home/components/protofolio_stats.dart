...
import 'package:protofolio/models/stat.dart';
import 'package:protofolio/utils/constans.dart';
import 'package:protofolio/utils/screen_helper.dart';
import 'package:responsive_framework/responsive_framework.dart';

final List<Stat> stats = [
  Stat(count: "10+", text: "klien"),
  Stat(count: "20+", text: "Projek"),
  Stat(count: "4", text: "Platform"),
  Stat(count: "5", text: "Tahun\nPengalaman"),
];

class ProtofolioStats extends StatelessWidget {
  @override
